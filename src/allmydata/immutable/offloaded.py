...
class CHKUploadHelper(Referenceable, upload.CHKUploader):
    ...
    def __init__(
        ...
        upload.CHKUploader.__init__(
            self, storage_broker, secret_holder, progress=progress
        )
        self._storage_index = storage_index
        self._helper = helper
        ...
        self._helper.log(
            "CHKUploadHelper starting for SI %s" % self._upload_id, parent=log_number
        )
