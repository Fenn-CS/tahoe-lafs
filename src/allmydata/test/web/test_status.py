...
class StatusTests(TrialTestCase):
    ...
    def test_status_page(self):
        ...
        doc = self._render_status_page(
            status._get_active_operations(), status._get_recent_operations()
        )
        ...
        assert_soup_has_tag_with_content(self, soup, "h2", "Active Operations:")

        assert_soup_has_tag_with_content(self, soup, "td", "retrieve")

        assert_soup_has_tag_with_content(self, soup, "td", "publish")

        assert_soup_has_tag_with_content(self, soup, "td", "download")

        assert_soup_has_tag_with_content(self, soup, "td", "upload")

        assert_soup_has_tag_with_content(self, soup, "h2", "Recent Operations:")
...
class DownloadStatusElementTests(TrialTestCase):
    ...
    def test_download_status_element(self):
        ...
        status = FakeDownloadStatus(
            ...
            {"fetch_per_server": {b"s-1": [1], b"s-2": [2, 3], b"s-3": [3, 2]}},
        )
        ...
        assert_soup_has_tag_with_content(
            self, soup, "title", "Tahoe-LAFS - File Download Status"
        )

        assert_soup_has_tag_with_content(self, soup, "li", "File Size: 123 bytes")
        assert_soup_has_tag_with_content(self, soup, "li", "Progress: 0.0%")

        assert_soup_has_tag_with_content(
            self, soup, "li", "Servers Used: [omwtc], [omwte], [omwtg]"
        )

        assert_soup_has_tag_with_content(self, soup, "li", "Server Problems:")

        assert_soup_has_tag_with_content(self, soup, "li", "[omwtc]: unknown problem")

        assert_soup_has_tag_with_content(self, soup, "li", "Servermap:")

        assert_soup_has_tag_with_content(self, soup, "li", "[omwtc] has share: #1")

        assert_soup_has_tag_with_content(self, soup, "li", "[omwte] has shares: #1,#2")

        assert_soup_has_tag_with_content(self, soup, "li", "[omwtg] has shares: #2,#3")

        assert_soup_has_tag_with_content(
            self, soup, "li", "Per-Server Segment Fetch Response Times:"
        )

        assert_soup_has_tag_with_content(self, soup, "li", "[omwtc]: 1.00s")

        assert_soup_has_tag_with_content(self, soup, "li", "[omwte]: 2.00s, 3.00s")

        assert_soup_has_tag_with_content(self, soup, "li", "[omwtg]: 3.00s, 2.00s")
    ...
    def test_download_status_element_partial(self):
        ...
        assert_soup_has_tag_with_content(self, soup, "li", "Servermap: None")

        assert_soup_has_tag_with_content(self, soup, "li", "File Size: 0 bytes")

        assert_soup_has_tag_with_content(self, soup, "li", "Total: None (None)")
