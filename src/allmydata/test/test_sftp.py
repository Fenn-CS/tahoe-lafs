...
class Handler(GridTestMixin, ShouldFailMixin, ReallyEqualMixin, unittest.TestCase):
    ...
    def _set_up_tree(self):
        ...
        d.addCallback(
            lambda ign: self.root._create_and_validate_node(
                None, self.mutable.get_readonly_uri(), name=u"readonly"
            )
        )
        ...
        d.addCallback(
            lambda ign: self.root._create_and_validate_node(
                None, empty_litdir_uri, name=u"empty_lit_dir"
            )
        )
        ...
        d.addCallback(
            lambda ign: self.root._create_and_validate_node(
                None, tiny_litdir_uri, name=u"tiny_lit_dir"
            )
        )
        ...
        d.addCallback(
            lambda ign: self.root._create_and_validate_node(
                None, unknown_uri, name=u"unknown"
            )
        )
    ...
    def test_basic(self):
        ...
        def _check(ign):
            ...
            self.failUnlessReallyEqual(self.handler._path_from_string("foo/"), [u"foo"])
            self.failUnlessReallyEqual(
                self.handler._path_from_string("/foo/"), [u"foo"]
            )
            self.failUnlessReallyEqual(
                self.handler._path_from_string("foo/bar"), [u"foo", u"bar"]
            )
            self.failUnlessReallyEqual(
                self.handler._path_from_string("/foo/bar"), [u"foo", u"bar"]
            )
            ...
            self.failUnlessReallyEqual(
                self.handler._path_from_string("foo/../bar"), [u"bar"]
            )
            self.failUnlessReallyEqual(
                self.handler._path_from_string("/foo/../bar"), [u"bar"]
            )
            self.failUnlessReallyEqual(
                self.handler._path_from_string("../bar"), [u"bar"]
            )
            self.failUnlessReallyEqual(
                self.handler._path_from_string("/../bar"), [u"bar"]
            )
    ...
    def test_not_implemented(self):
        ...
        d.addCallback(
            lambda ign: self.shouldFailWithSFTPError(
                sftp.FX_OP_UNSUPPORTED, "readLink link", self.handler.readLink, "link"
            )
        )
        d.addCallback(
            lambda ign: self.shouldFailWithSFTPError(
    ...
    def test_openDirectory_and_attrs(self):
        ...
        expected_root = [
            (
                "empty_lit_dir",
                r"dr-xr-xr-x .* 0 .* empty_lit_dir$",
                {"permissions": S_IFDIR | 0o555},
            ),
            (
                gross,
                r"-rw-rw-rw- .* 1010 .* " + gross + "$",
            ...
            (
                "small2",
                r"-rw-rw-rw- .* 26 .* small2$",
                {"permissions": S_IFREG | 0o666, "size": 26},
            ),
            (
                "tiny_lit_dir",
                r"dr-xr-xr-x .* 0 .* tiny_lit_dir$",
                {"permissions": S_IFDIR | 0o555},
            ),
        ...
        expected_tiny_lit = [
            (
                "short",
                r"-r--r--r-- .* 8 (Jan 01  1970|Dec 31  1969) short$",
    ...
    def test_openFile_read(self):
        ...
        d.addCallback(
            lambda ign: self.handler.openFile(
                "uri/" + self.small_uri, sftp.FXF_READ, {}
            )
        )
        ...
        d.addCallback(
            lambda ign: self.handler.openFile(
                "uri/" + self.gross_uri, sftp.FXF_READ, {}
            )
        )
        ...
        d.addCallback(
            lambda ign: self.handler.openFile(
                "uri/" + self.mutable_uri, sftp.FXF_READ, {}
            )
        )
        ...
        def _read_mutable_uri(rf):
            ...
            d2.addCallback(
                lambda data: self.failUnlessReallyEqual(data, "mutable file contents")
            )
            d2.addCallback(lambda ign: rf.close())
            return d2
        ...
        d.addCallback(
            lambda ign: self.handler.openFile(
                "uri/" + self.tiny_lit_dir_uri + "/short", sftp.FXF_READ, {}
            )
        )
    ...
    def test_openFile_read_error(self):
        ...
        d.addCallback(lambda ign: self.root.add_file(u"small", small))
        d.addCallback(
            lambda n: self.handler.openFile("/uri/" + n.get_uri(), sftp.FXF_READ, {})
        )
    ...
    def test_openFile_write(self):
        ...
        d.addCallback(
            lambda ign: self.handler.openFile(
                "newfile", sftp.FXF_WRITE | sftp.FXF_CREAT | sftp.FXF_TRUNC, {}
            )
        )
        ...
        d.addCallback(
            lambda data: self.failUnlessReallyEqual(
                data, "012345670123\x00a\x00\x00\x00"
            )
        )
        ...
        d.addCallback(lambda node: download_to_data(node))
        d.addCallback(
            lambda data: self.failUnlessReallyEqual(data, "01234567890123\x00\x00\x00z")
        )
        ...
        d.addCallback(
            lambda ign: self.handler.openFile(
                "newfile", sftp.FXF_WRITE | sftp.FXF_TRUNC, {}
            )
        )
        ...
        d.addCallback(
            lambda ign: self.handler.openFile(
                "newfile", sftp.FXF_WRITE | sftp.FXF_TRUNC, {"permissions": 0}
            )
        )
        d.addCallback(_write_trunc)
        d.addCallback(lambda ign: self.root.get(u"newfile"))
        ...
        d.addCallback(
            lambda ign: self.handler.openFile(
                "zerolength", sftp.FXF_WRITE | sftp.FXF_CREAT | sftp.FXF_EXCL, {}
            )
        )
        ...
        d.addCallback(
            lambda ign: self.handler.openFile(
                "creatappend", sftp.FXF_WRITE | sftp.FXF_CREAT | sftp.FXF_APPEND, {}
            )
        )
        ...
        d.addCallback(lambda node: download_to_data(node))
        d.addCallback(
            lambda data: self.failUnlessReallyEqual(data, "01234567890123401234")
        )

        # test WRITE | CREAT without TRUNC, when the file does not already exist
        d.addCallback(
            lambda ign: self.handler.openFile(
                "newfile2", sftp.FXF_WRITE | sftp.FXF_CREAT, {}
            )
        )
        ...
        d.addCallback(
            lambda data: self.failUnlessReallyEqual(data, "mutable new! contents")
        )

        # ... and with permissions, which should be ignored
        d.addCallback(
            lambda ign: self.handler.openFile(
                "mutable", sftp.FXF_WRITE, {"permissions": 0}
            )
        )
        d.addCallback(_write_mutable)
        d.addCallback(lambda ign: self.root.get(u"mutable"))
        ...
        def _write_mutable_setattr(wf):
            ...
            d2.addCallback(
                lambda ign: self.handler.setAttrs("mutable", {"permissions": 0o444})
            )
        ...
        d.addCallback(
            lambda data: self.failUnlessReallyEqual(
                data, "mutable read-only link from parent"
            )
        )

        # ... and then by handle
        d.addCallback(lambda ign: self.handler.openFile("mutable2", sftp.FXF_WRITE, {}))
        ...
        d.addCallback(
            lambda ign: self.handler.openFile(
                "small", sftp.FXF_READ | sftp.FXF_WRITE, {}
            )
        )
        ...
        def _read_write(rwf):
            ...
            d2.addCallback(
                lambda data: self.failUnlessReallyEqual(data, "012345670123")
            )
        ...
        d.addCallback(lambda ign: self.handler.openFile("small", sftp.FXF_WRITE, {}))
        ...
        d.addCallback(
            lambda ign: self.handler.openFile(
                "newexcl", sftp.FXF_WRITE | sftp.FXF_CREAT | sftp.FXF_EXCL, {}
            )
        )
        ...
        def _write_creat_excl_rename(wf):
            d2 = wf.writeChunk(0, "abcd")
            d2.addCallback(
                lambda ign: self.handler.renameFile("newexcl", "renamedexcl")
            )
            d2.addCallback(lambda ign: wf.writeChunk(4, "efgh"))
            d2.addCallback(lambda ign: wf.close())
            return d2
        ...
        def _open_and_rename_race(ign):
            ...
            d2 = self.handler.openFile(
                "new", sftp.FXF_WRITE | sftp.FXF_CREAT, {}, delay=slow_open
            )
        ...
        d.addCallback(
            lambda ign: self.shouldFail(
                NoSuchChildError, "rename new while open", "new", self.root.get, u"new"
            )
        )
    ...
    def test_removeFile(self):
        ...
        d.addCallback(
            lambda ign: self.shouldFailWithSFTPError(
                sftp.FX_NO_SUCH_FILE, "removefile ''", self.handler.removeFile, ""
            )
        )
        ...
        d.addCallback(
            lambda ign: self.handler.openFile(
                "tempfile", sftp.FXF_READ | sftp.FXF_WRITE | sftp.FXF_CREAT, {}
            )
        )
        ...
        d.addCallback(
            lambda ign: self.handler.openFile(
                "tempfile2", sftp.FXF_READ | sftp.FXF_WRITE | sftp.FXF_CREAT, {}
            )
        )
        ...
        def _write_rename_remove(rwf):
            d2 = rwf.writeChunk(0, "0123456789")
            d2.addCallback(
                lambda ign: self.handler.renameFile("tempfile2", "tempfile3")
            )
    ...
    def test_renameFile(self):
        ...
        def _rename_onto_heisenfile_race(wf):
            ...
            d2 = self.handler.openFile(
                "heisenfile", sftp.FXF_WRITE | sftp.FXF_CREAT, {}, delay=slow_open
            )
        ...
        d.addCallback(
            lambda ign: self.handler.renameFile(
                u"gro\u00DF".encode("utf-8"), u"loop/neue_gro\u00DF".encode("utf-8")
            )
        )
        ...
        d.addCallback(
            lambda ign: self.handler.renameFile("tiny_lit_dir", "new_tiny_lit_dir")
        )
    ...
    def test_extendedRequest(self):
        ...
        d.addCallback(
            lambda ign: self.handler.extendedRequest("statvfs@openssh.com", "/")
        )
        ...
        d.addCallback(
            lambda ign: self.shouldFailWithSFTPError(
                ...
                self.handler.extendedRequest,
                "posix-rename@openssh.com",
                "\x00\x00\x00\x01_\x00\x00\x00\x01",
            )
        )
