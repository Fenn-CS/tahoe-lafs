...
class HashUtilTests(unittest.TestCase):
    ...
    def test_known_answers(self):
        ...
        self._testknown(
            hashutil.block_hash,
            b"msjr5bh4evuh7fa3zw7uovixfbvlnstr5b65mrerwfnvjxig2jvq",
            b"",
        )
        self._testknown(
            hashutil.uri_extension_hash,
            b"wthsu45q7zewac2mnivoaa4ulh5xvbzdmsbuyztq2a5fzxdrnkka",
            b"",
        )
        self._testknown(
            hashutil.plaintext_hash,
            b"5lz5hwz3qj3af7n6e3arblw7xzutvnd3p3fjsngqjcb7utf3x3da",
            b"",
        )
        self._testknown(
            hashutil.crypttext_hash,
            b"itdj6e4njtkoiavlrmxkvpreosscssklunhwtvxn6ggho4rkqwga",
            b"",
        )
        self._testknown(
            hashutil.crypttext_segment_hash,
            b"aovy5aa7jej6ym5ikgwyoi4pxawnoj3wtaludjz7e2nb5xijb7aa",
            b"",
        )
        self._testknown(
            hashutil.plaintext_segment_hash,
            b"4fdgf6qruaisyukhqcmoth4t3li6bkolbxvjy4awwcpprdtva7za",
            b"",
        )
        self._testknown(
            hashutil.convergence_hash,
            b"3mo6ni7xweplycin6nowynw2we",
            3,
            10,
            100,
            b"",
        ...
        self._testknown(
            ...
            b"ujhr5k5f7ypkp67jkpx6jl4p47pyta7hu5m527cpcgvkafsefm6q",
            b"",
        )
        self._testknown(
            hashutil.my_cancel_secret_hash,
            b"rjwzmafe2duixvqy6h47f5wfrokdziry6zhx4smew4cj6iocsfaa",
            b"",
        )
        self._testknown(
            hashutil.file_renewal_secret_hash,
            b"hzshk2kf33gzbd5n3a6eszkf6q6o6kixmnag25pniusyaulqjnia",
            b"",
            b"si",
        )
        self._testknown(
            hashutil.file_cancel_secret_hash,
            b"bfciwvr6w7wcavsngxzxsxxaszj72dej54n4tu2idzp6b74g255q",
            b"",
            b"si",
        )
        self._testknown(
            hashutil.bucket_renewal_secret_hash,
            b"e7imrzgzaoashsncacvy3oysdd2m5yvtooo4gmj4mjlopsazmvuq",
            b"",
            b"\x00" * 20,
        )
        self._testknown(
            hashutil.bucket_cancel_secret_hash,
            b"dvdujeyxeirj6uux6g7xcf4lvesk632aulwkzjar7srildvtqwma",
            b"",
            b"\x00" * 20,
        )
        self._testknown(
            hashutil.hmac,
            b"c54ypfi6pevb3nvo6ba42jtglpkry2kbdopqsi7dgrm4r7tw5sra",
            b"tag",
            b"",
        )
        self._testknown(
            hashutil.mutable_rwcap_key_hash, b"6rvn2iqrghii5n4jbbwwqqsnqu", b"iv", b"wk"
        )
        self._testknown(hashutil.ssk_writekey_hash, b"ykpgmdbpgbb6yqz5oluw2q26ye", b"")
        self._testknown(
            hashutil.ssk_write_enabler_master_hash,
            b"izbfbfkoait4dummruol3gy2bnixrrrslgye6ycmkuyujnenzpia",
            b"",
        )
        self._testknown(
            hashutil.ssk_write_enabler_hash,
            b"fuu2dvx7g6gqu5x22vfhtyed7p4pd47y5hgxbqzgrlyvxoev62tq",
            b"wk",
            b"\x00" * 20,
        )
        self._testknown(
        ...
        self._testknown(
            hashutil.ssk_readkey_data_hash, b"73wsaldnvdzqaf7v4pzbr2ae5a", b"iv", b"rk"
        )
        self._testknown(
            hashutil.ssk_storage_index_hash, b"j7icz6kigb6hxrej3tv4z7ayym", b""
        )
