...
future_nonascii_read_uri = (
    u"x-tahoe-even-more-crazy-readonly://I_am_from_the_future_ro_\u263A".encode("utf-8")
)
...
class Dirnode(
    ...
    def _do_create_test(self, mdmf=False):
        ...
        def _then(n):
            ...
            if mdmf:
                ...
                cap_formats = ["URI:DIR2:", "URI:DIR2-RO", "URI:DIR2-Verifier:"]
            rw, ro, v = cap_formats
            ...
            d.addCallback(lambda res: n.set_uri(u"child", fake_file_uri, fake_file_uri))
            d.addCallback(
            ...
            d.addCallback(
                lambda children: self.failUnlessReallyEqual(
                    set(children.keys()), set([u"child", u"subdir"])
                )
            )
            ...
            d.addCallback(lambda res: n.get_child_and_metadata_at_path(u""))
            ...
            d.addCallback(lambda res: n.get_child_and_metadata_at_path(u"child"))
            ...
            d.addCallback(
                lambda res: n.get_child_and_metadata_at_path(u"subdir/subsubdir")
            )
            ...
            d.addCallback(
                lambda res: n.set_uri(u"c2", fake_file_uri, fake_file_uri, {})
            )
            ...
            d.addCallback(lambda res: n.set_uri(u"c3", fake_file_uri, fake_file_uri))
            ...
            d.addCallback(
                lambda res: n.set_uri(
                    u"c4", fake_file_uri, fake_file_uri, {"key": "value"}
                )
            )
            ...
            d.addCallback(lambda res: n.set_node(u"d4", n, {"key": "value"}))
                ...
                lambda res: n.set_children(
                    {
                        ...
                        u"e3": (fake_file_uri, fake_file_uri, {"key": "value"}),
                    }
                )
            )
            ...
            d.addCallback(
                lambda res: n.set_metadata_for(
                    u"child", {"tags": ["web2.0-compatible"], "tahoe": {"bad": "mojo"}}
                )
            )
            ...
            d.addCallback(
                lambda children: self.failUnlessReallyEqual(
                    set(children.keys()), set([u"child", u"newfile"])
                )
            )
            ...
            d.addCallback(
                lambda res: n.add_file(
                    u"newfile-metadata", uploadable3, {"key": "value"}
                )
            )
            d.addCallback(
                lambda newnode: self.failUnless(IImmutableFileNode.providedBy(newnode))
            ...
            def _created2(subdir2):
                ...
                return subdir2.add_file(
                    u"child", upload.Data("overwrite me", "converge")
                )

            d.addCallback(_created2)

            d.addCallback(lambda res: n.move_child_to(u"child", self.subdir2))
            d.addCallback(lambda res: n.list())
            d.addCallback(
                lambda children: self.failUnlessReallyEqual(
                    set(children.keys()), set([u"newfile", u"subdir2"])
                )
            )
            ...
            d.addCallback(
                lambda res: self.subdir2.move_child_to(u"child", n, u"newchild")
            )
            d.addCallback(lambda res: n.list())
            d.addCallback(
                lambda children: self.failUnlessReallyEqual(
                    set(children.keys()), set([u"newchild", u"newfile", u"subdir2"])
                )
            )
            d.addCallback(lambda res: self.subdir2.list())
            d.addCallback(
            ...
            d.addCallback(
                lambda res: self.subdir2.set_uri(
                    u"newchild", other_file_uri, other_file_uri
                )
            )
            ...
            d.addCallback(
                lambda ign: n.set_uri(u"mutable", other_file_uri, other_file_uri)
            )
            d.addCallback(lambda ign: n.get(u"mutable"))
            d.addCallback(lambda mutable: self.failIf(mutable.is_readonly(), mutable))
            d.addCallback(
                lambda ign: n.set_metadata_for(u"mutable", {"no-write": True})
            )
            d.addCallback(lambda ign: n.get(u"mutable"))
            d.addCallback(
            ...
            d.addCallback(
                lambda ign: n.set_metadata_for(u"subdir2", {"no-write": True})
            )
            d.addCallback(lambda ign: n.get(u"subdir2"))
            d.addCallback(
            ...
            d.addCallback(
                lambda ign: n.create_subdirectory(
                    u"subdir_ro", metadata={"no-write": True}
                )
            )
    ...
    def _do_initial_children_test(self, mdmf=False):
        ...
        kids = {
            ...
            u"two": (nm.create_from_cap(setup_py_uri), {"metakey": "metavalue"}),
        ...
        def _check_kids(children):
            ...
            self.failUnlessReallyEqual(
                fut_node.get_readonly_uri(), "ro." + future_read_uri
            )
            ...
            self.failUnlessReallyEqual(
                futna_node.get_readonly_uri(), "ro." + future_nonascii_read_uri
            )
            ...
            self.failUnlessReallyEqual(
                frona_node.get_uri(), "ro." + future_nonascii_read_uri
            )
            self.failUnlessReallyEqual(
                futna_node.get_readonly_uri(), "ro." + future_nonascii_read_uri
            )
            ...
            d2.addCallback(
                lambda children: self.failUnlessReallyEqual(
                    set(children.keys()), set([u"short"])
                )
            )
            d2.addCallback(lambda ignored: tinylit_node.list())
            d2.addCallback(lambda children: children[u"short"][0].read(MemAccum()))
            d2.addCallback(
                lambda accum: self.failUnlessReallyEqual(accum.data, "The end.")
            )
            return d2
    ...
    def test_immutable(self):
        ...
        def _check_kids(children):
            ...
            self.failUnlessReallyEqual(
                fut_node.get_readonly_uri(), "imm." + future_read_uri
            )
            self.failUnless(isinstance(fut_metadata, dict), fut_metadata)

            self.failUnless(futna_node.is_unknown())
            self.failUnlessReallyEqual(
                futna_node.get_uri(), "imm." + future_nonascii_read_uri
            )
            self.failUnlessReallyEqual(
                futna_node.get_readonly_uri(), "imm." + future_nonascii_read_uri
            )
            self.failUnless(isinstance(futna_metadata, dict), futna_metadata)
    ...
    def test_directory_representation(self):
        ...
        def _check_data(data):
            ...
            while position < len(data):
                ...
                self.failUnlessReallyEqual(
                    "ro." + ro_uri, expected_child.get_readonly_uri()
                )
                numkids += 1
        ...
        def _check_kids(children):
            ...
            self.failUnlessReallyEqual(
                child_node.get_readonly_uri(), "ro." + stripped_read_uri
            )
        ...
        def _created_subdir(subdir):
            ...
            d.addCallback(
                lambda dn: self._rootnode.set_uri(
                    u"rodir", dn.get_uri(), dn.get_readonly_uri()
                )
            )
            return d
    ...
    def _do_readonly_test(self, version=SDMF_VERSION):
        ...
        def _ready(rw_dn):
            ...
            self.shouldFail(
                dirnode.NotWriteableError, "set_uri ro", None, ro_dn.delete, u"child"
            )
            self.shouldFail(
                dirnode.NotWriteableError,
                "set_uri ro",
    ...
    def _do_create_subdirectory_test(self, version=SDMF_VERSION):
        ...
        def _then(n):
            ...
            kids = {
                u"kid1": (nm.create_from_cap(fake_file_uri), {}),
                u"kid2": (nm.create_from_cap(other_file_uri), md),
            }
            d = n.create_subdirectory(u"subdir", kids, mutable_version=version)
...
class Packing(testutil.ReallyEqualMixin, unittest.TestCase):
    ...
    def _check_children(self, children):
        ...
        self.failUnlessReallyEqual(
            file3_rocap, children[u"file3"][0].get_readonly_uri()
        )
        self.failUnlessReallyEqual(file3_rwcap, children[u"file3"][0].get_uri())
        ...
        self.failUnlessReallyEqual(
            file2_rocap, children[u"file2"][0].get_readonly_uri()
        )
        self.failUnlessReallyEqual(file2_rwcap, children[u"file2"][0].get_uri())
        ...
        self.failUnlessReallyEqual(
            file1_rocap, children[u"file1"][0].get_readonly_uri()
        )
        self.failUnlessReallyEqual(file1_rwcap, children[u"file1"][0].get_uri())

    def _make_kids(self, nm, which):
        caps = {
            "imm": "URI:CHK:n7r3m6wmomelk4sep3kw5cvduq:os7ijw5c3maek7pg65e5254k2fzjflavtpejjyhshpsxuqzhcwwq:3:20:14861",
...
class Dirnode2(testutil.ReallyEqualMixin, testutil.ShouldFailMixin, unittest.TestCase):
    ...
    def test_from_future(self):
        ...
        future_write_uri = u"x-tahoe-crazy://I_am_from_the_future_rw_\u263A".encode(
            "utf-8"
        )
        future_read_uri = (
            u"x-tahoe-crazy-readonly://I_am_from_the_future_ro_\u263A".encode("utf-8")
        )
        future_imm_uri = (
            u"x-tahoe-crazy-immutable://I_am_from_the_future_imm_\u263A".encode("utf-8")
        )
        ...
        d.addCallback(
            lambda ign: self._node.set_uri(
                u"add-pair", future_write_uri, future_read_uri
            )
        )
        ...
        d.addCallback(
            lambda ign: self._node.set_uri(u"add-ro", "ro." + future_read_uri, None)
        )
        d.addCallback(
            lambda ign: self._node.set_uri(u"add-imm", "imm." + future_imm_uri, None)
        )
...
class Adder(GridTestMixin, unittest.TestCase, testutil.ShouldFailMixin):
    def test_overwrite(self):
        ...
        def _create_directory_tree(root_node):
            ...
            # root/file2
            # root/dir1
            d = root_node.add_file(u"file1", upload.Data("Important Things", None))
            d.addCallback(
                lambda res: root_node.add_file(
                    u"file2", upload.Data("Sekrit Codes", None)
                )
            )
            d.addCallback(lambda res: root_node.create_subdirectory(u"dir1"))
        ...
        def _test_adder(root_node):
            ...
            d.addCallback(lambda res: root_node.create_subdirectory(u"dir2"))
            d.addCallback(lambda res: root_node.set_node(u"dir2", filenode))
            ...
            d.addCallback(
                lambda res: root_node.set_node(
                    u"file1", filenode, overwrite="only-files"
                )
            )
            d.addCallback(
                lambda res: self.shouldFail(
