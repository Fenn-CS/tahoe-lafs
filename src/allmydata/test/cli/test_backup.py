...
class Backup(GridTestMixin, CLITestMixin, StallMixin, unittest.TestCase):
    ...
    def progress_output(self, out):
        ...
        return list(
            ...
            for (progress, total, h, m, s) in mos
        )
    ...
    def test_backup(self):
        ...
        d.addCallback(
            lambda res: self.do_cli("get", "tahoe:backups/Latest/parent/subdir/foo.txt")
        )
        ...
        def _check7(args):
            ...
            return self.do_cli(
                "get",
                "tahoe:backups/Archives/%s/parent/subdir/foo.txt"
                % self.old_archives[0],
            )
    ...
    def test_exclude_options(self):
        ...
        self._check_filtering(
            filtered, root_listdir, ("lib.a", "_darcs", "subdir"), ("nice_doc.lyx",)
        )
        # multiple exclude
        ...
        filtered = list(backup_options.filter_listdir(root_listdir))
        self._check_filtering(
            filtered, root_listdir, ("_darcs", "subdir"), ("nice_doc.lyx", "lib.a")
        )
    ...
    def test_exclude_options_unicode(self):
        nice_doc = "nice_d\u00F8c.lyx"
        try:
            doc_pattern_arg_unicode = doc_pattern_arg = "*d\u00F8c*"
            if PY2:
        ...
        root_listdir = ("lib.a", "_darcs", "subdir", nice_doc)
        ...
        filtered = list(backup_options.filter_listdir(root_listdir))
        self._check_filtering(
            filtered, root_listdir, ("lib.a", "_darcs", "subdir"), (nice_doc,)
        )
        # multiple exclude
        backup_options = parse(
        ...
        filtered = list(backup_options.filter_listdir(root_listdir))
        self._check_filtering(
            filtered, root_listdir, ("_darcs", "subdir"), (nice_doc, "lib.a")
        )
        # read exclude patterns from file
    ...
    def test_exclude_from_tilde_expansion(self):
        ...
        exclude_file = "~/.tahoe/excludes.dummy"
        ...
        patcher.runWithPatches(
            ...
            basedir,
            "backup",
            ["--exclude-from-utf-8", unicode_to_argv(exclude_file), "from", "to"],
        )
    ...
    def test_ignore_symlinks(self):
        ...
        return self._ignore_something_test("Symlink", make_symlink)
    ...
    def test_ignore_fifo(self):
        ...
        return self._ignore_something_test("special", make_fifo)
    ...
    def _ignore_something_test(self, kind_of_thing, make_something_to_ignore):
        ...
        d = self.do_cli("create-alias", "tahoe")
        d.addCallback(
            lambda res: self.do_cli("backup", "--verbose", source, "tahoe:test")
        )
    ...
    def test_ignore_unreadable_file(self):
        ...
        def _check(args):
            ...
            self.failUnlessReallyEqual(
                err,
                "WARNING: permission denied on file %s\n"
    ...
    def test_ignore_unreadable_directory(self):
        ...
        def _check(args):
            ...
            self.failUnlessReallyEqual(
                err,
                "WARNING: permission denied on directory %s\n"
