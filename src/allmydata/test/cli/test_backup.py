...
class Backup(GridTestMixin, CLITestMixin, StallMixin, unittest.TestCase):
    ...
    def test_exclude_options(self):
        ...
        self._check_filtering(
            filtered, root_listdir, (u"lib.a", u"_darcs", u"subdir"), (u"nice_doc.lyx",)
        )
        # multiple exclude
        ...
        filtered = list(backup_options.filter_listdir(root_listdir))
        self._check_filtering(
            filtered, root_listdir, (u"_darcs", u"subdir"), (u"nice_doc.lyx", u"lib.a")
        )
    ...
    def test_exclude_options_unicode(self):
        ...
        filtered = list(backup_options.filter_listdir(root_listdir))
        self._check_filtering(
            filtered, root_listdir, (u"lib.a", u"_darcs", u"subdir"), (nice_doc,)
        )
        # multiple exclude
        backup_options = parse(
        ...
        filtered = list(backup_options.filter_listdir(root_listdir))
        self._check_filtering(
            filtered, root_listdir, (u"_darcs", u"subdir"), (nice_doc, u"lib.a")
        )
        # read exclude patterns from file
    ...
    def test_exclude_from_tilde_expansion(self):
        ...
        patcher.runWithPatches(
            ...
            basedir,
            "backup",
            ["--exclude-from", unicode_to_argv(exclude_file), "from", "to"],
        )
