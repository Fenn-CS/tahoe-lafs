...
class Check(GridTestMixin, CLITestMixin, unittest.TestCase):
    ...
    def test_deep_check(self):
        ...
        d.addCallback(lambda ign: c0.create_mutable_file(MutableData(DATA + "1")))
        ...
        d.addCallback(lambda fn: fn.add_file(u"subfile", upload.Data(DATA + "2", "")))
        d.addCallback(
            lambda ign: self.delete_shares_numbered(self.uris["subdir"], range(10))
        )
