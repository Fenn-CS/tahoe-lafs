...
class Handler(GridTestMixin, ReallyEqualMixin, unittest.TestCase):
    ...
    def _set_up(self, basedir, num_clients=1, num_servers=10):
        ...
        def _created_root(node):
            ...
            self.handler = ftpd.Handler(
                self.client, self.root, self.username, self.convergence
            )
    ...
    def _set_up_tree(self):
        ...
        md_both = {
            "mtime": self.FALL_OF_BERLIN_WALL,
        ...
        expected_root = [
            (
                ...
                [
                    0,
                    True,
                    ftpd.IntishPermissions(0o600),
                    1,
                    self.FALL_OF_BERLIN_WALL,
                    "alice",
                    "alice",
                    "??",
                ],
